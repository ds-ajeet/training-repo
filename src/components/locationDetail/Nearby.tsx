...
//                     {location.hours?
//                     <div className="flex open-now-string items-center " data-id={`main-shop-${main_result}`} >
...
//                       <Link className="btn" href={`/${main_result}`}
